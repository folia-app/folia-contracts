...
var Decomposer = require('./build/contracts/Decomposer.json')
var DecomposerMetadata = require('./build/contracts/DecomposerMetadata.json')
var DecomposerController = require('./build/contracts/DecomposerController.json')
